...
def service(mock_db, mock_storage):
    ...
    with patch("app.services.section_extraction_service.PDFProcessor") as mock_pdf, \
         ...
         patch("app.services.section_extraction_service.ExtractionEntityTypeRepository") as mock_entity_repo, \
         patch("app.services.section_extraction_service.ExtractionInstanceRepository") as mock_instance_repo, \
         patch("app.services.section_extraction_service.AISuggestionRepository") as mock_suggestion_repo, \
...
class TestSectionExtractionFullFlow:
    ...
    async def test_extract_section_full_flow(self, service, mock_storage):
        ...
        with patch("app.services.section_extraction_service.ExtractionInstance") as mock_instance_class, \
